      ...
      <section className="py-16 md:py-20 bg-white px-4">
         <div className="container mx-auto">
            ...
            <div className="max-w-4xl mx-auto">
               <div className="bg-white border border-slate-200 rounded-[32px] p-8 md:p-12 text-slate-900 shadow-xl">
                  <h3 className="text-2xl font-bold mb-8">Оставьте заявку</h3>
                  <form className="space-y-6" onSubmit={(e) => { e.preventDefault(); alert('Спасибо! Ваша заявка отправлена.'); }}>
                     ...
                     <div>
                        <label className="text-xs font-bold text-slate-400 ml-1 mb-2 block uppercase tracking-wide">Email</label>
                        <input 
                           type="email" 
